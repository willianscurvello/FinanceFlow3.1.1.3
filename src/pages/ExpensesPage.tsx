import React, { useState, useEffect } from 'react';
    ...
    export function ExpensesPage() {
      ...
      const handleAddExpense = async (e: React.FormEvent) => {
        ...
        if (!newExpense.description || !newExpense.category || !newExpense.employee_id || !newExpense.cardLastFour || !newExpense.date || newExpense.amount <= 0) {
        ...
        const { data, error } = await supabase
          ...
          .insert([{ 
            ...
            employee_id: newExpense.employee_id, // Usar o nome correto da coluna
            card_last_four: newExpense.cardLastFour, // Usar o nome correto da coluna
            date: newExpense.date,
            amount: newExpense.amount,
            receipt_link: newExpense.receiptLink, // Usar o nome correto da coluna
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setNewExpense({ ...newExpense, employee_id: e.target.value, cardLastFour: selectedEmployee?.cardlastfour || '' });
                      }}
                      className="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700"
                      required
                    >
